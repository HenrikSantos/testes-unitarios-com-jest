...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const keysOfRestaurante = Object.keys(meuRestaurante.fetchMenu());
    expect(keysOfRestaurante).toEqual(['food', 'drink'])
    ...
    expect(meuRestaurante.consumption).toEqual(["sopa"])
    ...
    meuRestaurante.order("sopa");
    expect(meuRestaurante.consumption).toEqual(["sopa","agua","sopa"])
